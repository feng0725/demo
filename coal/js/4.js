        ...
        series : [
            {
                ...
                data:[
                    {value:400, name:'招标采购 40%'},
                    {value:200, name:'定向采购 30%'},
                    {value:300, name:'集中采购 20%'},
                    {value:200, name:'竞争性谈判采购 10%'},
                ],
                roseType: 'radius',
    ...
    let option = {
        ...
        series: [

            {
                ...
                // smooth:true,
                data:[
                    {value:167,itemStyle:{normal:{color:'#0084f1'}}},
                    {value:140},
                    {value:130},
                    {value:120},
                    {value:110},
                    {value:100},
                    {value:90},
                    {value:80,itemStyle:{normal:{color:'#9c43a5'}}},
                ]
            }
        ]
    };
