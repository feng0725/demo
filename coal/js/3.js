...
let t06 = echarts.init(document.getElementById('t06'), 'customed');
let t07 = echarts.init(document.getElementById('t07'), 'customed');
let t08 = echarts.init(document.getElementById('t08'), 'customed');
        ...
        series : [
            {
                ...
                data:[
                    {value:400, name:'铁路 40%'},
                    {value:200, name:'公路 25%'},
                    {value:300, name:'轮船 35%'},
                ],
                roseType: 'radius',
        ...
        series : [
            {
                ...
                data:[
                    {value:400, name:'原煤 40%'},
                    {value:200, name:'洗煤 25%'},
                    {value:300, name:'商品煤 35%'},
                ],
                roseType: 'radius',
